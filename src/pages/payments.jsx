  ...
  <section className="full-width pageContent">
    ...
    <div className="mdl-tabs mdl-js-tabs mdl-js-ripple-effect">
      <div className="mdl-tabs__tab-bar">
        <a href="#tabNewPayment" className="mdl-tabs__tab is-active">
          NEW
        </a>
        <a href="#tabListPayment" className="mdl-tabs__tab">
          LIST
        </a>
      </div>
      <div className="mdl-tabs__panel is-active" id="tabNewPayment">
            ...
            <div className="full-width panel mdl-shadow--2dp">
              ...
              <div className="full-width panel-content">
                <form>
                  ...
                  <div className="mdl-tooltip" htmlFor="btn-addPayment">
                    Add payment
                  </div>
                  <p />
                </form>
      ...
      <div className="mdl-tabs__panel" id="tabListPayment">
        <div className="mdl-grid">
                ...
                <div className="mdl-list">
                  <div className="mdl-list__item mdl-list__item--two-line">
                    <span className="mdl-list__item-primary-content">
                      <i className="zmdi zmdi-card mdl-list__item-avatar" />
