			...
			<section className="full-width container-notifications">
				...
				<section className="NotificationArea">
					...
					<a href="#" className="Notification" id="notifation-unread-1">
						...
						<div className="mdl-tooltip mdl-tooltip--left" htmlFor="notifation-unread-1">
					...
					<a href="#" className="Notification" id="notifation-read-1">
						...
						<div className="mdl-tooltip mdl-tooltip--left" htmlFor="notifation-read-1">
					...
					<a href="#" className="Notification" id="notifation-unread-2">
						...
						<div className="mdl-tooltip mdl-tooltip--left" htmlFor="notifation-unread-2">
							Notification as UnRead
						</div>
					</a>
					<a href="#" className="Notification" id="notifation-read-2">
						...
						<div className="mdl-tooltip mdl-tooltip--left" htmlFor="notifation-read-2">
							Notification as Read
						</div>
					</a>
					<a href="#" className="Notification" id="notifation-read-3">
						...
						<div className="mdl-tooltip mdl-tooltip--left" htmlFor="notifation-read-3">
							Notification as Read
						</div>
					</a>
				</section>
			...
			<section className="full-width pageContent">
				...
				<div className="mdl-tabs mdl-js-tabs mdl-js-ripple-effect">
					<div className="mdl-tabs__tab-bar">
						<a href="#tabNewClient" className="mdl-tabs__tab is-active">
							NEW
						</a>
						<a href="#tabListClient" className="mdl-tabs__tab">
							LIST
						</a>
					</div>
					<div className="mdl-tabs__panel is-active" id="tabNewClient">
								...
								<div className="full-width panel mdl-shadow--2dp">
									...
									<div className="full-width panel-content">
										<form>
											<div className="mdl-grid">
												...
												<div className="mdl-cell mdl-cell--12-col">
													<div
														...
														<input className="mdl-textfield__input" type="number"
															pattern="-?[0-9]*(\.[0-9]+)?" id="DNIClient" />
														<label className="mdl-textfield__label" htmlFor="DNIClient">
															DNI
														</label>
												...
												<div className="mdl-cell mdl-cell--6-col mdl-cell--8-col-tablet">
													<div
														...
														<input className="mdl-textfield__input" type="text"
															pattern="-?[A-Za-záéíóúÁÉÍÓÚ ]*(\.[0-9]+)?" id="NameClient" />
														<label className="mdl-textfield__label" htmlFor="NameClient">
															Name
														</label>
														<span className="mdl-textfield__error">
															Invalid name
												...
												<div className="mdl-cell mdl-cell--6-col mdl-cell--8-col-tablet">
													<div
														className="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
														<input className="mdl-textfield__input" type="text"
															pattern="-?[A-Za-záéíóúÁÉÍÓÚ ]*(\.[0-9]+)?" id="LastNameClient" />
														<label className="mdl-textfield__label" htmlFor="LastNameClient">
															Last Name
														</label>
														<span className="mdl-textfield__error">
															Invalid last name
												...
												<div className="mdl-cell mdl-cell--6-col mdl-cell--8-col-tablet">
													<div
														...
														<input className="mdl-textfield__input" type="text"
															id="addressClient1" />
														<label className="mdl-textfield__label" htmlFor="addressClient1">
															Address 1
														</label>
														<span className="mdl-textfield__error">
															Invalid address
												...
												<div className="mdl-cell mdl-cell--6-col mdl-cell--8-col-tablet">
													<div
														...
														<input className="mdl-textfield__input" type="text"
															id="addressClient2" />
														<label className="mdl-textfield__label" htmlFor="addressClient2">
															Address 2
														</label>
														<span className="mdl-textfield__error">
															Invalid address
												...
												<div className="mdl-cell mdl-cell--6-col mdl-cell--8-col-tablet">
													<div
														...
														<input className="mdl-textfield__input" type="tel"
															pattern="-?[0-9+()- ]*(\.[0-9]+)?" id="phoneClient" />
														<label className="mdl-textfield__label" htmlFor="phoneClient">
															Phone
														</label>
														<span className="mdl-textfield__error">
												...
												<div className="mdl-cell mdl-cell--6-col mdl-cell--8-col-tablet">
													<div
														className="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
														<input className="mdl-textfield__input" type="email" id="emailClient" />
														<label className="mdl-textfield__label" htmlFor="emailClient">
															E-mail
														</label>
														<span className="mdl-textfield__error">
															Invalid E-mail
											...
											<div className="mdl-tooltip" htmlFor="btn-addClient">
												Add client
											</div>
											<p />
										</form>
					...
					<div className="mdl-tabs__panel" id="tabListClient">
						<div className="mdl-grid">
							<div
										...
										<form action="#">
											<div className="mdl-textfield mdl-js-textfield mdl-textfield--expandable">
												...
												<div className="mdl-textfield__expandable-holder">
													<input className="mdl-textfield__input" type="text" id="searchClient" />
										...
										<div className="mdl-list">
											<div className="mdl-list__item mdl-list__item--two-line">
												<span className="mdl-list__item-primary-content">
													<i className="zmdi zmdi-account mdl-list__item-avatar" />
